...
static void test_execute_undo_redo_preserves_identity(void)
{
    ...
    SiteHelperCommand command = add_wall_command(5000, 3000, 4200);
...
static void test_failure_does_not_consume_identity(void)
{
    ...
    SiteHelperCommand invalid = add_wall_command(0, 0, 4200);

    SiteHelperCommand existing = add_wall_command(0, 0, 4200);
...
static void test_history_interleaving_keeps_wall_ids(void)
{
    ...
    SiteHelperCommand first = add_wall_command(0, 0, 4200);
    SiteHelperCommand second = add_wall_command(5000, 3000, 4200);
